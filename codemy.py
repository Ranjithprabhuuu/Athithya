...
class FourthWindow(Screen):
    ...
    def place_order(self):
        ...
        cur=con.cursor()
        cur.execute("create table if not exists orderss(order_id integer PRIMARY KEY autoincrement,Dete varchar(500),waiter_name varchar(30),counter_no integer,item varchar(150),price int,quantity int)")
...
class SixthWindow(Screen):
    ...
    def place_order(self):
        ...
        cur = con.cursor()
        cur.execute(
            "insert into orderss(Dete,waiter_name,counter_no,item,price,quantity)values('{}','{}',{},'{}','{}','{}')".format(now1, w_name, counter, checkss, string1, quantity))
        con.commit()
        print("ORDER PLACED")
        con.close()
